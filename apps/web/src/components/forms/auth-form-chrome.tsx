...
export const formPrimaryButtonClassName =
	"h-11 w-full rounded-full bg-gray-950 px-4.5 text-white shadow-[0_1px_2px_rgba(15,23,42,0.06),0_10px_22px_-14px_rgba(15,23,42,0.22)] hover:bg-gray-800 hover:text-white hover:shadow-[0_1px_2px_rgba(15,23,42,0.08),0_18px_34px_-16px_rgba(15,23,42,0.34)] dark:bg-white dark:text-gray-950 dark:shadow-[0_1px_2px_rgba(0,0,0,0.14),0_12px_26px_-16px_rgba(0,0,0,0.4)] dark:hover:bg-gray-200 dark:hover:text-gray-950 dark:hover:shadow-[0_1px_2px_rgba(0,0,0,0.16),0_18px_34px_-16px_rgba(0,0,0,0.5)]";

export const formSecondaryButtonClassName =
	"h-11 rounded-full border border-transparent bg-white px-4.5 text-gray-700 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_18px_-14px_rgba(15,23,42,0.12)] hover:bg-stone-100 hover:text-gray-950 hover:shadow-[0_1px_2px_rgba(15,23,42,0.08),0_16px_30px_-16px_rgba(15,23,42,0.22)] dark:border-transparent dark:bg-gray-950 dark:text-gray-200 dark:shadow-[0_1px_2px_rgba(0,0,0,0.14),0_10px_24px_-16px_rgba(0,0,0,0.4)] dark:hover:bg-gray-900 dark:hover:text-gray-100 dark:hover:shadow-[0_1px_2px_rgba(0,0,0,0.18),0_16px_30px_-16px_rgba(0,0,0,0.5)]";

export const formToolbarButtonClassName =
	"inline-flex justify-center h-11 rounded-full border border-transparent bg-white px-4.5 text-sm text-gray-700 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_18px_-14px_rgba(15,23,42,0.12)] hover:bg-stone-100 hover:text-gray-950 hover:shadow-[0_1px_2px_rgba(15,23,42,0.08),0_16px_30px_-16px_rgba(15,23,42,0.22)] dark:border-transparent dark:bg-gray-950 dark:text-gray-200 dark:shadow-[0_1px_2px_rgba(0,0,0,0.14),0_10px_24px_-16px_rgba(0,0,0,0.4)] dark:hover:bg-gray-900 dark:hover:text-gray-100 dark:hover:shadow-[0_1px_2px_rgba(0,0,0,0.18),0_16px_30px_-16px_rgba(0,0,0,0.5)]";

export const formToolbarGhostButtonClassName =
	"inline-flex justify-center h-11 rounded-full border border-transparent bg-white px-4.5 text-sm text-gray-500 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_16px_-14px_rgba(15,23,42,0.1)] hover:bg-stone-100 hover:text-gray-950 hover:shadow-[0_1px_2px_rgba(15,23,42,0.08),0_14px_26px_-16px_rgba(15,23,42,0.18)] dark:border-transparent dark:bg-gray-950 dark:text-gray-400 dark:shadow-[0_1px_2px_rgba(0,0,0,0.14),0_10px_22px_-16px_rgba(0,0,0,0.36)] dark:hover:bg-neutral-900 dark:hover:text-gray-100 dark:hover:shadow-[0_1px_2px_rgba(0,0,0,0.18),0_16px_28px_-16px_rgba(0,0,0,0.44)]";

export const formToolbarSelectClassName =
	"h-11 rounded-full border border-transparent bg-white px-4.5 text-sm text-gray-700 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_18px_-14px_rgba(15,23,42,0.12)] hover:bg-gray-50 hover:shadow-[0_1px_2px_rgba(15,23,42,0.06),0_10px_22px_-14px_rgba(15,23,42,0.16)] dark:border-transparent dark:bg-gray-950 dark:text-gray-200 dark:shadow-[0_1px_2px_rgba(0,0,0,0.14),0_10px_24px_-16px_rgba(0,0,0,0.4)] dark:hover:bg-gray-900";
