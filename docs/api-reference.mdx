...
```bash
pnpm local                   # Start full local stack (installs deps, starts web + agent + docker services)
...
pnpm self-host               # Pull latest published images and start the self-hosted stack
